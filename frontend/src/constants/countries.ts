...
export const COUNTRIES: Country[] = [
    ...
    { code: "GB", name: "United Kingdom", dialCode: "+44", flag: "🇬🇧", priority: 2 },
    { code: "CA", name: "Canada", dialCode: "+1", flag: "🇨🇦", priority: 3 },
    { code: "AU", name: "Australia", dialCode: "+61", flag: "🇦🇺", priority: 4 },
    { code: "DE", name: "Germany", dialCode: "+49", flag: "🇩🇪", priority: 5 },
    { code: "FR", name: "France", dialCode: "+33", flag: "🇫🇷", priority: 6 },
    { code: "IN", name: "India", dialCode: "+91", flag: "🇮🇳", priority: 7 },
    { code: "JP", name: "Japan", dialCode: "+81", flag: "🇯🇵", priority: 8 },
    { code: "CN", name: "China", dialCode: "+86", flag: "🇨🇳", priority: 9 },
    { code: "BR", name: "Brazil", dialCode: "+55", flag: "🇧🇷", priority: 10 },
